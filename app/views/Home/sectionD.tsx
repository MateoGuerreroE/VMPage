        ...
        <div className="flex flex-col items-start w-full h-full justify-center lg:w-[1500px] lg:px-[50px]">
          <div className="w-full h-full justify-center flex flex-col lg:w-1/2 gap-14">
            ...
            <div className="flex flex-row">
              <div id="draws" className="mr-5 py-2">
                <div className="w-5 h-5 bg-white rounded-full"></div>
                <div className="flex flex-row w-full h-[4em] justify-center">
              ...
              <div className="flex flex-col w-full gap-2.5">
                ...
                <div className="flex flex-col">
                  <h5 className="font-display text-xl">Presidente</h5>
                  <p className="font-dmsans">
                    del Congreso Mundial de Altas ​Jurisdicciones
                    Administrativas
                  </p>
                </div>
                ...
                <div className="flex flex-col mb-2">
                  <h5 className="font-display text-xl">Profesor </h5>
                  <p className="font-dmsans">
                    titular de la Universidad Externado de Colombia y de 27
                ...
                <div className="flex flex-col">
                  <h5 className="font-display text-xl">Director</h5>
                  <p className="font-dmsans">
                    de la colección en ciencias ​sociales y la Biblioteca
                    ​Millenium en derecho ​económico y de los negocios
                  </p>
                </div>
              </div>
            </div>
