...
export default function SectionA() {
  return (
    <section className="h-[100vh] w-full bg-mazo bg-cover bg-center text-white px-10 lg:p-0 flex lg:justify-center">
      <div className="flex flex-col items-start h-full justify-center lg:w-[1500px] lg:px-[50px]">
        <div className="flex flex-col max-w-[500px] gap-7">
          ...
          <p className="font-dmsans leading-5 mb-3">
            Somos un Buffet Jurídico con soporte ​interdisciplinario para
            atender las diferentes áreas en ​materia de consultoría y litigio
